...
2. [AppEmbed Demo](http://www.appemit.com/demo/AppEmbed.html)   [Office Demo](http://www.appemit.com/demo/office.html)   [Demo](http://www.appemit.com/demo/index.html) 
...
- **主要实现功能：**	
 ...
 - 各个应用程序之间通信，比如聊天
 - 在Chrome里嵌入IE内核网页，可以不修改原有的ActiveX读取html，同时支持开源内核wke和blink
