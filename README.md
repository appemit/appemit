...
### main features:
 ...
 -  Play web pages or Flash files containing flash in almost any browser(chrome edge firefox QQ 360 Yandex sogou opera), including swf interactive animations, flv movies, etc.
